...
int main(int argc, char **argv)
{
  ...
  auto node =rclcpp::Node::make_shared("wheel_operator");

  double lin_vel_step = 0.01;
  double ang_vel_step = 0.1;

  RCLCPP_INFO(node->get_logger(),"You can set '-lin_vel_step' and  '-ang_vel_step' arguments (default is 0.01 and 0.1)");
